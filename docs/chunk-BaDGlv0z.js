...
var J = class t extends U {
  ...
  static ɵcmp = bl({
    type: t,
    selectors: [['fal-datepicker']],
    features: [zm([pa()], [zr]), sm],
    decls: 8,
    vars: 9,
    consts: [
      ['picker', ''],
    ...
    template: function (o, e) {
      if (
        (o & 1 &&
          ...
          hm(2, 'input', 3),
          YI(),
          hm(3, 'mat-datepicker-toggle', 4)(4, 'mat-datepicker', null, 0),
          xl(),
          ym(6, 5, 1)),
        o & 2)
      ) {
        ...
        (pm('appearance', e.control.config.appearance),
          ...
          H_(),
          pm('matDatepicker', p)('formControlName', e.control.formControlName)(
            'placeholder',
    ...
    dependencies: [Ft, Dt, qe, qi, ra, na, $n, qn, ra$1, Ha, wy, JC, iT, Ur, si, Lr, jn, H, J$1],
    styles: ['.w-full[_ngcontent-%COMP%]{width:100%}'],
    changeDetection: 1,
  });
};
export { J as DatepickerComponent };
